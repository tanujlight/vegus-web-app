...
@Component({
  ...
  templateUrl: './view-drag-drop-triads.component.html',
  styleUrls: ['./view-drag-drop-triads.component.scss']
})
export class ViewDragDropTriadsComponent implements OnInit {
