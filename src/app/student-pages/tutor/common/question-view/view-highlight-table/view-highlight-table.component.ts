...
@Component({
  ...
  templateUrl: './view-highlight-table.component.html',
  styleUrls: ['./view-highlight-table.component.scss']
})
export class ViewHighlightTableComponent implements OnInit {
  @Input() question: any
