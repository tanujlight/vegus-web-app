    ...
    this.tableColumns = {
      ...
      questions: {
        ...
        valuePrepareFunction: (cell, row) => {
          const url = `/admin/questions/list-view?category=${this.categoryId}&subCategory=${row.id}`
      ...
      caseStudies: {
        ...
        type: 'html',
        valuePrepareFunction: (cell, row) => {
          const url = `/admin/case-studies/list-view?category=${this.categoryId}&subCategory=${row.id}`
