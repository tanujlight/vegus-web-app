...
import {Exam, QuestionAndCaseStudy, ExamStatusListWithTitle} from '../assesments.interface'
  ...
  handleSuccessResponse() {
    switch (this.mode) {
      case ExamFormMode.ADD:
        ...
        this.routeTo(`admin/exams/edit/${this.examId}`)
        break
