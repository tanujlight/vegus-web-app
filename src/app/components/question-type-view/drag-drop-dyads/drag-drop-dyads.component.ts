...
import {DragDropDyadsQuestion} from '../../../admin-pages/questions/questions.interface'

@Component({
  selector: 'ngx-view-drag-drop-dyads',
  templateUrl: './drag-drop-dyads.component.html',
  styleUrls: ['./drag-drop-dyads.component.scss']
})
export class DragDropDyadsViewComponent implements OnInit {
