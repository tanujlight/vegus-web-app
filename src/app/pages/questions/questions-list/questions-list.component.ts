      ...
      case 'edit':
        if (this.caseStudyId) {
          if (this.isDialog) {
            ...
            this.routeTo(`pages/case-studies/edit/${this.caseStudyId}/questions/${event.data.id}`)
          }
        } else {
          this.routeTo(`pages/questions/edit/${event.data.id}`)
        }
        break

      case 'add':
        if (this.caseStudyId) {
          this.routeTo(`pages/case-studies/edit/${this.caseStudyId}/questions/new`)
        } else {
          this.routeTo(`pages/questions/new`)
        }
        break
